  ...
  return (
    ...
    >
      <div className="max-w-screen-lg p-4 mx-auto flex-col justify-center   w-full h-full">
        <div className="pb-10">
          <p className="text-4xl shadow-text font-bold inline border-b-4 border-gray-500">
            Experience
          </p>
          <p className="py-6">
            Check out some of my Experience and Education right here
          </p>
        </div>

        <div className="card-wrapper flex flex-wrap  sm:flex-nowrap sm:w-full mt-5 flex md:flex-nowrap sm:gap-10 mx-auto ">
          <div className="left w-full flex items-center justify-between">
            <fieldset
              data-aos="zoom-in"
              className="p-15 py-10 sm:w-full sm:px-0"
            >
              ...
              <div className=" relative">
                ...
                <div className=" flex flex-col gap-1 sm:gap-1 border-4 hover:border-yellow-700 hover:shadow-[0px_0px_16px_1px_rgba(0,0,0,0.1)] p-5 rounded-lg bg-white">
                  ...
                  <p className=" text-[.9rem] text-justify break-words text-gray-500">
                    In mI'm working as a Full Stack Developernt using React JS,
          ...
          <div className="right w-full flex  items-center justify-between">
            <fieldset
              data-aos="zoom-in"
              className="p-15 py-10 sm:w-full sm:px-0"
            >
              ...
              <div className=" relative">
                ...
                <div className=" flex flex-col gap-1 sm:gap-1 border-4 hover:border-yellow-700 hover:shadow-[0px_0px_16px_1px_rgba(0,0,0,0.1)] p-5 rounded-lg bg-white">
                  ...
                  <p className=" text-[.9rem] text-justify text-gray-500">
                    ...
                    CSS, JavaScript, and React.js, Next.js. Additionally, I'm
